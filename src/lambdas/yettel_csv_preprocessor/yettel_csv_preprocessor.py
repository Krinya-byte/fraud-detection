...
def lambda_handler(event, context):
    ...
    try:
        ...
        s3.put_object(Bucket=curated_bucket, Key=output_key, Body=csv_buffer.getvalue())

        return {
            "statusCode": 200,
            "body": json.dumps(
                {"message": "File processed successfully", "source_file": source_key, "output_file": output_key}
            ),
        }
